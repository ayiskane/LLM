...
export const alphabetNav = {
  card: 'absolute right-1 top-1/2 -translate-y-1/2 z-40 flex flex-col items-center py-2 px-1 select-none touch-none rounded-lg bg-slate-800/25 border border-slate-600/30 shadow-lg backdrop-blur-sm',
